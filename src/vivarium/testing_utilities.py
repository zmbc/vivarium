...
class NonCRNTestPopulation:
    ...
    def setup(self, builder):
        ...
        builder.population.initializes_simulants(self.generate_test_population, creates_columns=columns)
...
def build_table(value, year_start, year_end, columns=("age", "year", "sex", "value")):
    ...
    return pd.DataFrame(rows, columns=["age_start", "age_end", "year_start", "year_end", "sex"] + list(value_columns))
