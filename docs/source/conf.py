...
latex_documents = [
    (master_doc, f'{about["__title__"]}.tex', f'{about["__title__"]} Documentation', about["__author__"], "manual"),
]
...
man_pages = [(master_doc, f'{about["__title__"]}', f'{about["__title__"]} Documentation', [author], 1)]
